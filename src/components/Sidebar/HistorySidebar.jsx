                ...
                <>
                    <div className="sidebar-header">
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                            <h3 style={{ fontSize: '1.2rem', margin: 0 }}>All Your Demos</h3>
                            <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Access Your Workspace</span>
                        </div>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                                        <span style={{ fontSize: '0.8rem', fontWeight: 600 }}>Connect with Google Drive</span>
                                        <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)' }}>Sign in to share links directly.</span>
                                    </div>
                                </div>
                    ...
                    {!directoryHandle ? (
                        ...
                        <div className="sidebar-content">
                            ...
                            {libraryFiles.length === 0 ? (
                                <div className="empty-state">Can't find any recordings in this folder.</div>
                            ) : (
